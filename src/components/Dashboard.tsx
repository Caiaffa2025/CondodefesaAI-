...
import { PlusCircle, FileText, Calendar, ChevronRight, AlertTriangle, ShieldCheck, Info, FileCheck, Search, Filter, ArrowUpRight, Clock, Bell, BellRing, CheckCircle2, Trophy, Camera, Sparkles, Zap, FolderOpen, Calculator } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 py-6 md:py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                          ...
                          <div className="flex items-center gap-2 mb-0.5 md:mb-1">
                            <h3 className="font-black text-base sm:text-lg md:text-xl text-slate-900 group-hover:text-blue-600 transition-colors truncate">
                              {c.problemType === 'multa' ? 'Multa Injusta' : 
                               ...
                               c.problemType === 'taxa_indevida' ? 'Taxa Indevida' : 'Outro Problema'}
                            </h3>
                          </div>
        ...
        <div className="space-y-4">
          ...
          <motion.div 
            whileHover={{ y: -2 }}
            className="bg-gradient-to-br from-emerald-600 to-emerald-800 rounded-xl p-3 text-white shadow-md relative overflow-hidden group mb-2"
          >
            <div className="relative z-10">
              <div className="w-7 h-7 bg-white/20 rounded-lg flex items-center justify-center mb-2">
                <Calculator className="w-3.5 h-3.5 text-white" />
              </div>
              <h3 className="text-sm font-black mb-0.5 tracking-tight">Calculadora</h3>
              <p className="text-emerald-100 text-[8px] leading-tight mb-3">
                Verifique juros e multas legais.
              </p>
              <Link 
                to="/calculadora" 
                className="w-full bg-white text-emerald-600 py-1.5 rounded-lg font-black hover:bg-emerald-50 transition-all flex items-center justify-center gap-1.5 text-[9px]"
              >
                Calcular
                <Calculator className="w-2.5 h-2.5" />
              </Link>
            </div>
            <Calculator className="absolute -bottom-3 -right-3 w-12 h-12 text-white/10 group-hover:scale-110 transition-transform duration-500" />
          </motion.div>

          {/* Occurrence Report Card */}
          <motion.div 
            whileHover={{ y: -2 }}
            className="bg-gradient-to-br from-blue-700 to-blue-900 rounded-xl p-3 text-white shadow-md relative overflow-hidden group mb-2"
          >
            <div className="relative z-10">
              <div className="w-7 h-7 bg-white/20 rounded-lg flex items-center justify-center mb-2">
                <FileText className="w-3.5 h-3.5 text-white" />
              </div>
              <h3 className="text-sm font-black mb-0.5 tracking-tight">Ata Digital</h3>
              <p className="text-blue-100 text-[8px] leading-tight mb-3">
                Registre problemas profissionalmente.
              </p>
              <Link 
                to="/ata-digital" 
                className="w-full bg-white text-blue-700 py-1.5 rounded-lg font-black hover:bg-blue-50 transition-all flex items-center justify-center gap-1.5 text-[9px]"
              >
                Gerar Ata
                <FileText className="w-2.5 h-2.5" />
              </Link>
            </div>
            <FileText className="absolute -bottom-3 -right-3 w-12 h-12 text-white/10 group-hover:scale-110 transition-transform duration-500" />
          </motion.div>

          {/* Quiz Card */}
          <motion.div 
            whileHover={{ y: -2 }}
            className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-xl p-3 text-white shadow-md relative overflow-hidden group mb-2"
          >
            <div className="relative z-10">
              <div className="w-7 h-7 bg-white/20 rounded-lg flex items-center justify-center mb-2">
                <Trophy className="w-3.5 h-3.5 text-white" />
              </div>
              <h3 className="text-sm font-black mb-0.5 tracking-tight">Quiz</h3>
              <p className="text-blue-100 text-[8px] leading-tight mb-3">
                Teste seus conhecimentos.
              </p>
              <Link 
                to="/quiz" 
                className="w-full bg-white text-blue-600 py-1.5 rounded-lg font-black hover:bg-blue-50 transition-all flex items-center justify-center gap-1.5 text-[9px]"
              >
                Começar
                <ArrowUpRight className="w-2.5 h-2.5" />
              </Link>
            </div>
            <Trophy className="absolute -bottom-3 -right-3 w-12 h-12 text-white/10 group-hover:scale-110 transition-transform duration-500" />
          </motion.div>

          {/* Scanner Card */}
          <motion.div 
            whileHover={{ y: -2 }}
            className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-3 text-white shadow-md relative overflow-hidden group mb-2"
          >
            <div className="relative z-10">
              <div className="w-7 h-7 bg-white/10 rounded-lg flex items-center justify-center mb-2">
                <Camera className="w-3.5 h-3.5 text-blue-400" />
              </div>
              <h3 className="text-sm font-black mb-0.5 tracking-tight">Scanner</h3>
              <p className="text-slate-400 text-[8px] leading-tight mb-3">
                Analise legalidade de multas.
              </p>
              <Link 
                to="/scanner" 
                className="w-full bg-blue-600 text-white py-1.5 rounded-lg font-black hover:bg-blue-700 transition-all flex items-center justify-center gap-1.5 text-[9px] shadow-lg shadow-blue-900/20"
              >
                Escanear
                <Camera className="w-2.5 h-2.5" />
              </Link>
            </div>
            <Camera className="absolute -bottom-3 -right-3 w-12 h-12 text-white/5 group-hover:scale-110 transition-transform duration-500" />
          </motion.div>

          {/* Preventive Card */}
          <motion.div 
            whileHover={{ y: -2 }}
            className="bg-gradient-to-br from-emerald-600 to-teal-700 rounded-xl p-3 text-white shadow-md relative overflow-hidden group mb-2"
          >
            <div className="relative z-10">
              <div className="w-7 h-7 bg-white/20 rounded-lg flex items-center justify-center mb-2">
                <ShieldCheck className="w-3.5 h-3.5 text-white" />
              </div>
              <h3 className="text-sm font-black mb-0.5 tracking-tight">Preventiva</h3>
              <p className="text-emerald-100 text-[8px] leading-tight mb-3">
            ...
            <ShieldCheck className="absolute -bottom-3 -right-3 w-12 h-12 text-white/10 group-hover:scale-110 transition-transform duration-500" />
          </motion.div>

          {/* Documents Card */}
          <motion.div 
            whileHover={{ y: -2 }}
            className="bg-white rounded-xl p-3 border border-slate-100 shadow-sm mb-2 relative overflow-hidden group"
          >
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-2">
                ...
                {profile?.condoConvention && profile?.internalRegulations ? (
                  <span className="bg-emerald-100 text-emerald-700 text-[7px] font-black px-1.5 py-0.5 rounded-md uppercase tracking-widest">OK</span>
                ) : (
                  <span className="bg-slate-100 text-slate-500 text-[7px] font-black px-1.5 py-0.5 rounded-md uppercase tracking-widest">PENDENTE</span>
                )}
              </div>
              <h3 className="text-sm font-black text-slate-900 mb-0.5 tracking-tight">Documentos</h3>
              <p className="text-slate-500 text-[8px] leading-tight mb-3">
                Gerencie seus arquivos.
              </p>
              <Link 
                to="/documentos" 
                className="w-full bg-slate-900 text-white py-1.5 rounded-lg font-black hover:bg-slate-800 transition-all flex items-center justify-center gap-1.5 text-[9px]"
              >
                Gerenciar
                <ArrowUpRight className="w-2.5 h-2.5" />
              </Link>
          ...
          <motion.div 
            whileHover={{ y: -2 }}
            className="bg-slate-900 rounded-xl p-3 text-white shadow-lg relative overflow-hidden group mb-2"
          >
            <div className="relative z-10">
              <div className="inline-block px-1.5 py-0.5 bg-blue-600 rounded-md text-[7px] font-black uppercase tracking-widest mb-2">
                Plano {profile?.plan === 'pro' ? 'PRO' : 'FREE'}
              </div>
              <h3 className="text-sm font-black mb-1 tracking-tight">Status da Conta</h3>
              <p className="text-slate-400 text-[8px] leading-tight mb-4">
                {profile?.plan === 'pro' 
              ...
              {profile?.plan !== 'pro' && (
                <button 
                  ...
                  className="w-full bg-white text-slate-900 py-1.5 rounded-lg font-black hover:bg-blue-50 transition-all flex items-center justify-center gap-1.5 text-[9px]"
                >
                  Fazer Upgrade
                  <ArrowUpRight className="w-2.5 h-2.5" />
                </button>
            ...
            <ShieldCheck className="absolute -bottom-4 -right-4 w-16 h-16 text-white/5 group-hover:scale-110 transition-transform duration-500" />
          </motion.div>
          ...
          <div className="bg-white rounded-xl p-3 border border-slate-100 shadow-sm mb-2">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className={cn(
                ...
                notificationsEnabled ? "bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]" : "bg-slate-300"
              )} />
            </div>
            <p className="text-[8px] text-slate-500 leading-tight mb-3">
              Receba avisos em tempo real.
            </p>
            {!notificationsEnabled ? (
              <button 
                onClick={handleEnableNotifications}
                className="w-full bg-blue-50 text-blue-600 py-1.5 rounded-lg font-bold hover:bg-blue-100 transition-all flex items-center justify-center gap-1.5 text-[9px]"
              >
                <BellRing className="w-2.5 h-2.5" />
                Ativar
              </button>
            ) : (
              <div className="flex items-center gap-1.5 text-emerald-600 font-bold text-[9px] bg-emerald-50 p-1.5 rounded-lg">
          ...
          {/* Smart Alerts */}
          <div className="bg-white rounded-xl p-3 border border-slate-100 shadow-sm mb-2 relative overflow-hidden">
            ...
            <div className="space-y-1.5">
              {[
                { 
                  ...
                  desc: "Detectamos alteração suspeita.",
                  type: "warning" 
                },
                { 
                  title: "Conteste cobrança", 
                  desc: "Taxa extra possui vícios.",
                  type: "info" 
                }
              ].map((alert, i) => (
                <motion.div 
                  ...
                  className={cn(
                    "p-1.5 rounded-lg border flex gap-1.5",
                    alert.type === 'warning' ? "bg-red-50 border-red-100" : "bg-blue-50 border-blue-100"
                  )}
                >
                  <Zap className={cn("w-2.5 h-2.5 shrink-0", alert.type === 'warning' ? "text-red-500" : "text-blue-500")} />
                  <div>
                    <h4 className={cn("font-bold text-[9px] mb-0.5", alert.type === 'warning' ? "text-red-900" : "text-blue-900")}>
                      {alert.title}
                    </h4>
                    <p className={cn("text-[8px] leading-tight", alert.type === 'warning' ? "text-red-700/70" : "text-blue-700/70")}>
                      {alert.desc}
                    </p>
                  </div>
                </motion.div>
          ...
          <div className="bg-white rounded-xl p-3 border border-slate-100 shadow-sm">
            ...
            <div className="space-y-2">
              {[
                { title: "Documentação", text: "Registre tudo por e-mail." },
                { title: "Regras", text: "Peça cópia da convenção." },
                { title: "Defesa", text: "Exija direito de defesa." }
              ].map((tip, i) => (
                <div key={i} className="flex gap-1.5">
                  <div className="w-5 h-5 rounded-md bg-blue-50 flex items-center justify-center shrink-0 font-black text-blue-600 text-[9px]">
                    {i + 1}
                  </div>
                  <div>
                    <h4 className="font-bold text-slate-800 text-[9px] mb-0.5">{tip.title}</h4>
                    <p className="text-[8px] text-slate-500 leading-tight">{tip.text}</p>
                  </div>
                </div>
              ))}
            </div>
