...
export default function LandingPage({ user }: LandingPageProps) {
  ...
  return (
    <div className="overflow-hidden bg-white" ref={containerRef}>
      ...
      <section className="relative min-h-[90vh] flex items-center pt-20 pb-32 overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10 overflow-hidden">
          ...
          <motion.div 
            ...
            className="absolute bottom-[30%] left-[10%] hidden lg:block"
          >
            <div className="bg-white/80 backdrop-blur-md p-4 rounded-2xl shadow-2xl border border-white/50 flex items-center gap-3">
          ...
          <div className="text-center">
            ...
            >
              <motion.div 
                ...
                className="inline-flex items-center gap-2 px-4 py-2 mb-8 rounded-full bg-blue-50 border border-blue-100 text-blue-700 text-xs font-bold uppercase tracking-widest shadow-sm"
              >
              ...
              {/* Partners/Logos */}
              <div className="mt-20 pt-10 border-t border-slate-100 flex flex-wrap justify-center gap-8 md:gap-16 opacity-30 grayscale">
                <div className="text-xl font-black tracking-tighter">OAB/SP</div>
                <div className="text-xl font-black tracking-tighter italic">CÓDIGO CIVIL</div>
                <div className="text-xl font-black tracking-tighter">LGPD COMPLIANT</div>
                <div className="text-xl font-black tracking-tighter">AI JUSTICE</div>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-32 bg-slate-50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-20">
            <h2 className="text-sm font-black text-blue-600 uppercase tracking-[0.2em] mb-4">Poder de Fogo</h2>
            <h3 className="text-4xl md:text-5xl font-black text-slate-900">Tecnologia a favor do morador</h3>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <motion.div 
              whileHover={{ y: -10 }}
              className="sm:col-span-2 lg:col-span-2 bg-white p-6 sm:p-10 rounded-[2rem] sm:rounded-[2.5rem] shadow-sm border border-slate-100 flex flex-col md:flex-row gap-6 sm:gap-10 items-center"
            >
              <div className="bg-blue-600 p-6 rounded-3xl text-white shadow-blue-200 shadow-2xl">
                <Shield className="w-12 h-12" />
              </div>
              <div>
                <h4 className="text-2xl font-black text-slate-900 mb-4">Análise com IA Jurídica</h4>
                <p className="text-slate-600 text-lg leading-relaxed">Nossa plataforma não apenas lê seu relato; ela cruza cada detalhe com o Código Civil, a Lei do Condomínio e jurisprudências recentes para encontrar brechas e abusos.</p>
              </div>
            </motion.div>
            ...
            >
              <AlertTriangle className="w-12 h-12 mb-8 opacity-50" />
              <div>
                <h4 className="text-2xl font-black mb-4">Detecta Abusos Reais</h4>
                <p className="text-blue-100 leading-relaxed">Dizemos explicitamente se há abuso da síndica ou administradora no seu caso, sem rodeios.</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                <h4 className="text-2xl font-black text-slate-900 mb-4">Defesa Automática</h4>
                <p className="text-slate-600 leading-relaxed">Gera notificações jurídicas e impugnações automaticamente, formatadas e prontas para envio.</p>
              </div>
            </motion.div>

            <motion.div 
              whileHover={{ y: -10 }}
              className="sm:col-span-2 lg:col-span-2 bg-slate-900 p-6 sm:p-10 rounded-[2rem] sm:rounded-[2.5rem] shadow-2xl text-white flex flex-col md:flex-row gap-6 sm:gap-10 items-center"
            >
              <div className="bg-blue-600 p-6 rounded-3xl text-white">
                <Zap className="w-12 h-12" />
              </div>
              <div>
                <h4 className="text-2xl font-black mb-4">Velocidade de Resposta</h4>
                <p className="text-slate-400 text-lg leading-relaxed">O que levaria semanas com um consultor tradicional, resolvemos em menos de 2 minutos. O tempo está do seu lado.</p>
              </div>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
            <div className="max-w-2xl">
              <h2 className="text-sm font-black text-blue-600 uppercase tracking-[0.2em] mb-4 text-center md:text-left">O que combatemos</h2>
              <h3 className="text-4xl md:text-6xl font-black text-slate-900 text-center md:text-left leading-tight">Identificamos abusos que você nem sabia que existiam</h3>
            </div>
            <p className="text-slate-600 text-lg max-w-sm text-center md:text-right">Não aceite cobranças ou regras sem antes passar pela nossa análise.</p>
          </div>
      ...
      <section id="como-funciona" className="py-32 bg-slate-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-24">
            <h2 className="text-sm font-black text-blue-400 uppercase tracking-[0.2em] mb-4">O Caminho</h2>
            <h3 className="text-4xl md:text-5xl font-black">Simples, rápido e 100% digital</h3>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 sm:gap-16">
            {[
              ...
              >
                <div className="text-7xl sm:text-8xl font-black text-white/5 absolute -top-10 sm:-top-12 -left-4 select-none">
                  {item.step}
                </div>
                <div className="bg-blue-600 w-16 h-16 rounded-2xl flex items-center justify-center mb-8 shadow-xl shadow-blue-900/20 group-hover:scale-110 transition-transform">
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-24">
            <h2 className="text-sm font-black text-blue-600 uppercase tracking-[0.2em] mb-4">Impacto Real</h2>
            <h3 className="text-4xl md:text-5xl font-black text-slate-900">O que dizem nossos usuários</h3>
          </div>
            ...
            {[
              ...
              >
                <div className="flex gap-1 mb-6 sm:mb-8">
                  {[...Array(item.stars)].map((_, j) => <Star key={j} className="w-4 h-4 sm:w-5 sm:h-5 fill-current text-yellow-400" />)}
                </div>
                <p className="text-xl sm:text-2xl font-medium text-slate-800 mb-8 sm:mb-10 leading-relaxed italic">"{item.text}"</p>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 text-[10px] sm:text-sm font-bold uppercase tracking-wider">{item.role}</p>
                  </div>
                </div>
              </motion.div>
            ))}
      ...
      <section className="py-32 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-sm font-black text-blue-600 uppercase tracking-[0.2em] mb-4">Dúvidas</h2>
            <h3 className="text-4xl font-black text-slate-900">Perguntas Frequentes</h3>
          </div>
            ...
            {[
              ...
              >
                <details className="group">
                  <summary className="flex justify-between items-center p-8 cursor-pointer list-none font-black text-lg text-slate-900">
                    <div className="flex items-center gap-4">
